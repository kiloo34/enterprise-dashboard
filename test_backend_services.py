...
def run_tests():
    ...
    check_service("IAM Service", "/api/user/me", expected_status=401)
    ...
    check_service("Engine Service (Logs)", "/api/engine/monitor/logs", expected_status=401)
    
    # Test 5: Engine Service (Stats)
    check_service("Engine Service (Stats)", "/api/engine/monitor/stats", expected_status=401)

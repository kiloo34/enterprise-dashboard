...
# Due to Spatie's polymorphic structure, model_has_roles works differently.
# We'll map model_has_roles specifically to the users model for simplicity in FastAPI if there's only one model.

...
export function QrisDataTable({ network, dateFilter, onDateFilterChange }: QrisDataTableProps) {
    ...
    const {
        ...
        totalItems,
        isLoading
    } = useQrisData(network, dateFilter, onDateFilterChange);

    if (isLoading) {
        return (
            <div className="bg-white dark:bg-gray-900 rounded-xl border border-gray-200 dark:border-gray-800 shadow-sm overflow-hidden p-8">

...
class EngineService(engine_pb2_grpc.EngineServiceServicer):
    ...
    async def GetFactKinerjaAggregate(self, request, context: grpc.aio.ServicerContext) -> engine_pb2.FactKinerjaResponse:
        ...
        try:
            ...
            try:
                # Validation will raise UnauthorizedException if invalid or expired
            ...
            async with AsyncSessionLocal() as db:
                # 1. Pastikan tabel sumber telah terbuat dari impor terbaru (via Celery/Kafka)
                ...
                # 2. Lakukan kalkulasi agregat performa
            ...
            # Map the aggregated dictionaries to FactKinerjaRow
            response_rows = []
